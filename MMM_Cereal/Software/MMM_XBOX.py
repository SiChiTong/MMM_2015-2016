...
while(True):
  ...
  if(xboxCont.LEFTTHUMB):
    ...
    # Control Shoulder
    mmm.leftShoulder += xboxCont.LTHUMBX*5
    # Control Elbow
    mmm.leftElbow = -xboxCont.LTHUMBY*90+90
  ...
  if(xboxCont.RIGHTTHUMB):
    ...
    # Control Shoulder
    mmm.rightShoulder -= xboxCont.RTHUMBX*5
    # Control Elbow
    mmm.rightElbow = -xboxCont.RTHUMBY*90+90
  
  # Activate Left Gripper
  if(xboxCont.LB):
    mmm.setLeftGrippers(180,180,180,180,180,180,180)
  else:
    mmm.setLeftGrippers(0,0,0,0,0,0,0)
    
  # Activate Right Gripper
  if(xboxCont.RB):
    mmm.setRightGrippers(180,180,180,180,180,180,180)
  else:
